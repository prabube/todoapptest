...
let connectionString='mongodb+srv://TodoApp:TodoApp@cluster0-tzdaw.mongodb.net/TodoApp?retryWrites=true&w=majority'
...
function passwordProtected(req,res,next){
  ...
  if(req.headers.authorization == "Basic cHJhYnU6OTYzOTYz"){
    next()
  }else{
    res.status(401).send("Authendication required")
  }  
}
